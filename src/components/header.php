...
<header class="header">
    <nav class="header__nav">
        <ul class="header__nav__list">
            ...
            <li class="header__nav__item">
                <a href="./catalogue.php" class="header__nav__link">
                    Каталог
                </a>
            </li>
        </ul>
    </nav>
    <a class="header__logo" href="/">Lina</a>
